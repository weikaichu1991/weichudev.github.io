...
const APILINK_ARTICLE = 'https://europe-west1-weichudev-web2024.cloudfunctions.net/api/article-04-firebase-hosting';
...
async function saveComment(nameInputId, emailInputId, subjectInputId, commentInputId, id = "") {
    ...
    const article = "article-04-firebase-hosting"
